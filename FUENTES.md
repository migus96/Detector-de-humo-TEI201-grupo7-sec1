...
-  Comprensión: El equipo entiende que el código usa ESP-NOW para recibir datos del emisor MQ-2, pausa ESP-NOW temporalmente para conectarse al WiFi y enviar el mensaje por HTTPS a la API de Telegram, y luego restaura ESP-NOW para seguir escuchando. La bandera volatile bool hayAlerta actúa como puente entre el callback de interrupción y el loop principal.
